...
function XRouter(selector){
    ...
    this.defaultHandlers[XRouter.TYPE_CALL] = this._routeSystem.bind(this);
    this.defaultHandlers[XRouter.TYPE_CALL] = this._routeSystem.bind(this);
    this.defaultHandlers[XRouter.TYPE_GET_TUNNEL] = this._routeSystem.bind(this);
    this.defaultHandlers[XRouter.TYPE_GET_TUNNEL] = this._routeSystem.bind(this);
    this.defaultHandlers[XRouter.TYPE_RESPONSE] = this._routeSystem.bind(this);
